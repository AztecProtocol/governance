...
## Namespace Reference
ChainType binary key: `0xa27c`
[CAIP-104] namespace: `aztec`

## Chain reference

Aztec chains are L2s that settle to EVM. As such, every one can be identified via the EVM chain they settle to 
